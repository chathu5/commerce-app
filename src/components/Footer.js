...
import newsletter from "../images/a3.webp";
const Footer = () => {
  return (
   <>
        ...
        <div className="row align-items-center">
          <div className="col-5">
            <div className="footer-top-data d-flex gap-30 align-item-center">
              <img src={newsletter} alt="newsletter" width="35px" />
            ...
            <div className="col-4">
              ...
              <div>
                <address className="text-white fs-6">
                  Hno: 387 Nugemulla Road,<br/> Mahanampura, <br/> Colombo<br/>
                  Pincode: 231245
                </address>
                < a href="tel : +93 74563459021" 
                className="mt-3 d-block mb-1  text-white"
                >
                  +93 74563459021
                </a>
                < a href=" mailto : devcorner@gmail.com"
        ...
        <div className="row">
          <div className="col-12">
            <p className="text-center mb-0 text-white">
              &copy;{new Date().getFullYear()}; Powered by TechHive
